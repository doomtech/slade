...
void MainApp::initActions() {
	...
	// TextureEditorPanel
	new SAction("txed_new", "New Texture", "", "Create a new, empty texture");
	new SAction("txed_delete", "Delete Texture", "", "Deletes the selected texture(s) from the list");
	new SAction("txed_new_patch", "New Texture from Patch", "", "Create a new texture from an existing patch");
	new SAction("txed_new_file", "New Texture from File", "", "Create a new texture from an image file");
