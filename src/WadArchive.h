...
public:
	...
	QList<ArchiveEntry*>	findEntries(string search, bool includesubdirs = true);
	QList<ArchiveEntry*>	findEntries(int edftype, bool includesubdirs = true);

	static bool exportEntriesAsWad(string filename, QList<ArchiveEntry*> entries) {
		WadArchive wad;
