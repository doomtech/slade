 ...
 * Filename:    CompositeTextureCanvas.cpp
...
/*******************************************************************
 * COMPOSITETEXTURECANVAS CLASS FUNCTIONS
 *******************************************************************/

/* CompositeTextureCanvas::CompositeTextureCanvas
 * CompositeTextureCanvas class constructor
 *******************************************************************/
...
/* CompositeTextureCanvas::~CompositeTextureCanvas
 * CompositeTextureCanvas class destructor
 *******************************************************************/
CompositeTextureCanvas::~CompositeTextureCanvas() {
}

/* CompositeTextureCanvas::openTexture
...
/* CompositeTextureCanvas::drawChequeredBackground
...
void CompositeTextureCanvas::drawTexture() {
	// Push matrix
	glPushMatrix();
...
void CompositeTextureCanvas::drawPatch(int num) {
	// Get patch to draw
