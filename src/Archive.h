...
public:
	...
	// Detection
	virtual QList<mapdesc_t>	detectMaps() = 0;
	...
	virtual QList<ArchiveEntry*>	findEntries(string search, bool incsub = true) = 0;
	virtual QList<ArchiveEntry*>	findEntries(int edftype, bool incsub = true) = 0;
};
