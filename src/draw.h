...
void draw_texture_scale(rect_t rect, string texname = _T("_notex"), int textype = 0, rgba_t col = COL_WHITE, float scalef = 1.0f);
void draw_texture(int x, int y, int width = -1, int height = -1, string texname = _T("_notex"), int textype = 0, rgba_t col = COL_WHITE);
