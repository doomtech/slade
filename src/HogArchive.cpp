...
/* HogArchive::open
 * Reads a hog format file from disk
 * Returns true if successful, false otherwise
 *******************************************************************/
bool HogArchive::open(string filename) {
...
/* HogArchive::open
 * Reads hog format data from an ArchiveEntry
 * Returns true if successful, false otherwise
 *******************************************************************/
bool HogArchive::open(ArchiveEntry* entry) {
...
/* HogArchive::write
 * Writes the hog archive to a file
 * Returns true if successful, false otherwise
 *******************************************************************/
bool HogArchive::write(string filename, bool update) {
