...
/* LfdArchive::open
 * Reads a lfd format file from disk
 * Returns true if successful, false otherwise
 *******************************************************************/
bool LfdArchive::open(string filename) {
...
/* LfdArchive::open
 * Reads lfd format data from an ArchiveEntry
 * Returns true if successful, false otherwise
 *******************************************************************/
bool LfdArchive::open(ArchiveEntry* entry) {
