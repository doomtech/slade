...
Objects=src/$(IntermediateDirectory)/GfxConvDialog$(ObjectSuffix) src/$(IntermediateDirectory)/ModifyOffsetsDialog$(ObjectSuffix) src/$(IntermediateDirectory)/PaletteDialog$(ObjectSuffix) src/$(IntermediateDirectory)/Clipboard$(ObjectSuffix) src/$(IntermediateDirectory)/Console$(ObjectSuffix) src/$(IntermediateDirectory)/CVar$(ObjectSuffix) src/$(IntermediateDirectory)/MainApp$(ObjectSuffix) src/$(IntermediateDirectory)/MemChunk$(ObjectSuffix) src/$(IntermediateDirectory)/Misc$(ObjectSuffix) src/$(IntermediateDirectory)/Tokenizer$(ObjectSuffix) \
	...
	src/$(IntermediateDirectory)/PaletteEntryPanel$(ObjectSuffix) src/$(IntermediateDirectory)/SwitchesEntryPanel$(ObjectSuffix) src/$(IntermediateDirectory)/TextEntryPanel$(ObjectSuffix) src/$(IntermediateDirectory)/TextureXEntryPanel$(ObjectSuffix) src/$(IntermediateDirectory)/PnamesEntryPanel$(ObjectSuffix) src/$(IntermediateDirectory)/ZipArchivePanel$(ObjectSuffix) src/$(IntermediateDirectory)/ZipEntryListPanel$(ObjectSuffix) src/$(IntermediateDirectory)/ArchiveManagerPanel$(ObjectSuffix) src/$(IntermediateDirectory)/MainWindow$(ObjectSuffix) src/$(IntermediateDirectory)/EntryOperations$(ObjectSuffix) \
	src/$(IntermediateDirectory)/MapLine$(ObjectSuffix) src/$(IntermediateDirectory)/MapSector$(ObjectSuffix) src/$(IntermediateDirectory)/MapSide$(ObjectSuffix) src/$(IntermediateDirectory)/MapThing$(ObjectSuffix) src/$(IntermediateDirectory)/MapVertex$(ObjectSuffix) src/$(IntermediateDirectory)/SLADEMap$(ObjectSuffix) src/$(IntermediateDirectory)/MapCanvas$(ObjectSuffix) src/$(IntermediateDirectory)/MapEditorWindow$(ObjectSuffix) src/$(IntermediateDirectory)/Archive$(ObjectSuffix) src/$(IntermediateDirectory)/ArchiveEntry$(ObjectSuffix) \
	src/$(IntermediateDirectory)/ArchiveManager$(ObjectSuffix) src/$(IntermediateDirectory)/WadArchive$(ObjectSuffix) src/$(IntermediateDirectory)/ZipArchive$(ObjectSuffix) src/$(IntermediateDirectory)/EntryType$(ObjectSuffix) src/$(IntermediateDirectory)/AnimatedList$(ObjectSuffix) src/$(IntermediateDirectory)/SwitchesList$(ObjectSuffix) src/$(IntermediateDirectory)/PnamesList$(ObjectSuffix) src/$(IntermediateDirectory)/SImage$(ObjectSuffix) src/$(IntermediateDirectory)/Palette$(ObjectSuffix) src/$(IntermediateDirectory)/PaletteManager$(ObjectSuffix) \
	src/$(IntermediateDirectory)/CTexture$(ObjectSuffix) src/$(IntermediateDirectory)/TextureXList$(ObjectSuffix) src/$(IntermediateDirectory)/Icons$(ObjectSuffix) src/$(IntermediateDirectory)/GLTexture$(ObjectSuffix) src/$(IntermediateDirectory)/ColourBox$(ObjectSuffix) src/$(IntermediateDirectory)/CTextureCanvas$(ObjectSuffix) src/$(IntermediateDirectory)/GfxCanvas$(ObjectSuffix) src/$(IntermediateDirectory)/ListView$(ObjectSuffix) src/$(IntermediateDirectory)/OGLCanvas$(ObjectSuffix) src/$(IntermediateDirectory)/PaletteCanvas$(ObjectSuffix) \
	src/$(IntermediateDirectory)/PaletteChooser$(ObjectSuffix) src/$(IntermediateDirectory)/TextEditor$(ObjectSuffix) src/$(IntermediateDirectory)/ConsolePanel$(ObjectSuffix) src/$(IntermediateDirectory)/SplashWindow$(ObjectSuffix) src/$(IntermediateDirectory)/BaseResourceArchivesPanel$(ObjectSuffix) 
...
src/$(IntermediateDirectory)/AnimatedEntryPanel$(ObjectSuffix): src/AnimatedEntryPanel.cpp src/$(IntermediateDirectory)/AnimatedEntryPanel$(DependSuffix)
	@test -d src/Release || $(MakeDirCommand) src/Release
	$(CompilerName) $(SourceSwitch) "/home/simon/dev/slade/trunk/src/AnimatedEntryPanel.cpp" $(CmpOptions) $(ObjectSwitch)src/$(IntermediateDirectory)/AnimatedEntryPanel$(ObjectSuffix) $(IncludePath)
src/$(IntermediateDirectory)/AnimatedEntryPanel$(DependSuffix): src/AnimatedEntryPanel.cpp
	@test -d src/Release || $(MakeDirCommand) src/Release
	@$(CompilerName) $(CmpOptions) $(IncludePath) -MTsrc/$(IntermediateDirectory)/AnimatedEntryPanel$(ObjectSuffix) -MFsrc/$(IntermediateDirectory)/AnimatedEntryPanel$(DependSuffix) -MM "/home/simon/dev/slade/trunk/src/AnimatedEntryPanel.cpp"
...
src/$(IntermediateDirectory)/SwitchesEntryPanel$(ObjectSuffix): src/SwitchesEntryPanel.cpp src/$(IntermediateDirectory)/SwitchesEntryPanel$(DependSuffix)
	@test -d src/Release || $(MakeDirCommand) src/Release
	$(CompilerName) $(SourceSwitch) "/home/simon/dev/slade/trunk/src/SwitchesEntryPanel.cpp" $(CmpOptions) $(ObjectSwitch)src/$(IntermediateDirectory)/SwitchesEntryPanel$(ObjectSuffix) $(IncludePath)
src/$(IntermediateDirectory)/SwitchesEntryPanel$(DependSuffix): src/SwitchesEntryPanel.cpp
	@test -d src/Release || $(MakeDirCommand) src/Release
	@$(CompilerName) $(CmpOptions) $(IncludePath) -MTsrc/$(IntermediateDirectory)/SwitchesEntryPanel$(ObjectSuffix) -MFsrc/$(IntermediateDirectory)/SwitchesEntryPanel$(DependSuffix) -MM "/home/simon/dev/slade/trunk/src/SwitchesEntryPanel.cpp"
...
src/$(IntermediateDirectory)/PnamesEntryPanel$(ObjectSuffix): src/PnamesEntryPanel.cpp src/$(IntermediateDirectory)/PnamesEntryPanel$(DependSuffix)
	@test -d src/Release || $(MakeDirCommand) src/Release
	$(CompilerName) $(SourceSwitch) "/home/simon/dev/slade/trunk/src/PnamesEntryPanel.cpp" $(CmpOptions) $(ObjectSwitch)src/$(IntermediateDirectory)/PnamesEntryPanel$(ObjectSuffix) $(IncludePath)
src/$(IntermediateDirectory)/PnamesEntryPanel$(DependSuffix): src/PnamesEntryPanel.cpp
	@test -d src/Release || $(MakeDirCommand) src/Release
	@$(CompilerName) $(CmpOptions) $(IncludePath) -MTsrc/$(IntermediateDirectory)/PnamesEntryPanel$(ObjectSuffix) -MFsrc/$(IntermediateDirectory)/PnamesEntryPanel$(DependSuffix) -MM "/home/simon/dev/slade/trunk/src/PnamesEntryPanel.cpp"
...
src/$(IntermediateDirectory)/AnimatedList$(ObjectSuffix): src/AnimatedList.cpp src/$(IntermediateDirectory)/AnimatedList$(DependSuffix)
	@test -d src/Release || $(MakeDirCommand) src/Release
	$(CompilerName) $(SourceSwitch) "/home/simon/dev/slade/trunk/src/AnimatedList.cpp" $(CmpOptions) $(ObjectSwitch)src/$(IntermediateDirectory)/AnimatedList$(ObjectSuffix) $(IncludePath)
src/$(IntermediateDirectory)/AnimatedList$(DependSuffix): src/AnimatedList.cpp
	@test -d src/Release || $(MakeDirCommand) src/Release
	@$(CompilerName) $(CmpOptions) $(IncludePath) -MTsrc/$(IntermediateDirectory)/AnimatedList$(ObjectSuffix) -MFsrc/$(IntermediateDirectory)/AnimatedList$(DependSuffix) -MM "/home/simon/dev/slade/trunk/src/AnimatedList.cpp"

src/$(IntermediateDirectory)/SwitchesList$(ObjectSuffix): src/SwitchesList.cpp src/$(IntermediateDirectory)/SwitchesList$(DependSuffix)
	@test -d src/Release || $(MakeDirCommand) src/Release
	$(CompilerName) $(SourceSwitch) "/home/simon/dev/slade/trunk/src/SwitchesList.cpp" $(CmpOptions) $(ObjectSwitch)src/$(IntermediateDirectory)/SwitchesList$(ObjectSuffix) $(IncludePath)
src/$(IntermediateDirectory)/SwitchesList$(DependSuffix): src/SwitchesList.cpp
	@test -d src/Release || $(MakeDirCommand) src/Release
	@$(CompilerName) $(CmpOptions) $(IncludePath) -MTsrc/$(IntermediateDirectory)/SwitchesList$(ObjectSuffix) -MFsrc/$(IntermediateDirectory)/SwitchesList$(DependSuffix) -MM "/home/simon/dev/slade/trunk/src/SwitchesList.cpp"

src/$(IntermediateDirectory)/PnamesList$(ObjectSuffix): src/PnamesList.cpp src/$(IntermediateDirectory)/PnamesList$(DependSuffix)
	@test -d src/Release || $(MakeDirCommand) src/Release
	$(CompilerName) $(SourceSwitch) "/home/simon/dev/slade/trunk/src/PnamesList.cpp" $(CmpOptions) $(ObjectSwitch)src/$(IntermediateDirectory)/PnamesList$(ObjectSuffix) $(IncludePath)
src/$(IntermediateDirectory)/PnamesList$(DependSuffix): src/PnamesList.cpp
	@test -d src/Release || $(MakeDirCommand) src/Release
	@$(CompilerName) $(CmpOptions) $(IncludePath) -MTsrc/$(IntermediateDirectory)/PnamesList$(ObjectSuffix) -MFsrc/$(IntermediateDirectory)/PnamesList$(DependSuffix) -MM "/home/simon/dev/slade/trunk/src/PnamesList.cpp"
...
src/$(IntermediateDirectory)/BaseResourceArchivesPanel$(ObjectSuffix): src/BaseResourceArchivesPanel.cpp src/$(IntermediateDirectory)/BaseResourceArchivesPanel$(DependSuffix)
	@test -d src/Release || $(MakeDirCommand) src/Release
	$(CompilerName) $(SourceSwitch) "/home/simon/dev/slade/trunk/src/BaseResourceArchivesPanel.cpp" $(CmpOptions) $(ObjectSwitch)src/$(IntermediateDirectory)/BaseResourceArchivesPanel$(ObjectSuffix) $(IncludePath)
src/$(IntermediateDirectory)/BaseResourceArchivesPanel$(DependSuffix): src/BaseResourceArchivesPanel.cpp
	@test -d src/Release || $(MakeDirCommand) src/Release
	@$(CompilerName) $(CmpOptions) $(IncludePath) -MTsrc/$(IntermediateDirectory)/BaseResourceArchivesPanel$(ObjectSuffix) -MFsrc/$(IntermediateDirectory)/BaseResourceArchivesPanel$(DependSuffix) -MM "/home/simon/dev/slade/trunk/src/BaseResourceArchivesPanel.cpp"
...
clean:
	...
	$(RM) src/$(IntermediateDirectory)/AnimatedEntryPanel$(ObjectSuffix)
	$(RM) src/$(IntermediateDirectory)/AnimatedEntryPanel$(DependSuffix)
	$(RM) src/$(IntermediateDirectory)/AnimatedEntryPanel$(PreprocessSuffix)
	...
	$(RM) src/$(IntermediateDirectory)/SwitchesEntryPanel$(ObjectSuffix)
	$(RM) src/$(IntermediateDirectory)/SwitchesEntryPanel$(DependSuffix)
	$(RM) src/$(IntermediateDirectory)/SwitchesEntryPanel$(PreprocessSuffix)
	...
	$(RM) src/$(IntermediateDirectory)/PnamesEntryPanel$(ObjectSuffix)
	$(RM) src/$(IntermediateDirectory)/PnamesEntryPanel$(DependSuffix)
	$(RM) src/$(IntermediateDirectory)/PnamesEntryPanel$(PreprocessSuffix)
	...
	$(RM) src/$(IntermediateDirectory)/AnimatedList$(ObjectSuffix)
	$(RM) src/$(IntermediateDirectory)/AnimatedList$(DependSuffix)
	$(RM) src/$(IntermediateDirectory)/AnimatedList$(PreprocessSuffix)
	$(RM) src/$(IntermediateDirectory)/SwitchesList$(ObjectSuffix)
	$(RM) src/$(IntermediateDirectory)/SwitchesList$(DependSuffix)
	$(RM) src/$(IntermediateDirectory)/SwitchesList$(PreprocessSuffix)
	$(RM) src/$(IntermediateDirectory)/PnamesList$(ObjectSuffix)
	$(RM) src/$(IntermediateDirectory)/PnamesList$(DependSuffix)
	$(RM) src/$(IntermediateDirectory)/PnamesList$(PreprocessSuffix)
	...
	$(RM) src/$(IntermediateDirectory)/BaseResourceArchivesPanel$(ObjectSuffix)
	$(RM) src/$(IntermediateDirectory)/BaseResourceArchivesPanel$(DependSuffix)
	$(RM) src/$(IntermediateDirectory)/BaseResourceArchivesPanel$(PreprocessSuffix)
	$(RM) $(OutputFile)
