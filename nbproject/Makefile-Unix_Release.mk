...
${OBJECTDIR}/src/Wad.o: src/Wad.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Wad.o src/Wad.cpp
...
${OBJECTDIR}/src/ZipWad.o: src/ZipWad.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ZipWad.o src/ZipWad.cpp
...
${OBJECTDIR}/src/LumpListPanel.o: src/LumpListPanel.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/LumpListPanel.o src/LumpListPanel.cpp

${OBJECTDIR}/src/Lump.o: src/Lump.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Lump.o src/Lump.cpp
